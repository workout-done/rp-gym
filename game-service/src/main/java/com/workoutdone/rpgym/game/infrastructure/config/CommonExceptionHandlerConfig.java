package com.workoutdone.rpgym.game.infrastructure.config;
...
/**
 * common 모듈의 공통 예외 처리를 game-service 에 등록한다.
 *
 * <p>{@code @SpringBootApplication} 의 컴포넌트 스캔 범위가 {@code com.workoutdone.rpgym.game} 라
